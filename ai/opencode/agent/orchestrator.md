---
description: >-
  The master system conductor that directs the entire lifecycle of the project
  from raw idea to 100% completion. Manages workspace state and dictates orders
  to specialized subagents sequentially.
mode: subagent
tools:
  bash: false
  edit: false
