---
description: >-
  Runs automated local execution test suites, analyzes error stacks, and demands
  bug fixes until code is flawless. Full terminal command privileges for testing.
mode: subagent
tools:
  bash: true
  edit: true
